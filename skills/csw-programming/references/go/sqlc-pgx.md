...
The reference current PostgreSQL stack. **Type-safe SQL with zero runtime reflection**, hot-path-friendly connection pooling, sane migrations, real Postgres in tests.
...
| Performance | 2–5x slower than pgx | pgx is the often performant Go pg driver |
