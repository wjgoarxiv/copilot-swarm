...
The TUI stack for current. Use **v2 RC**, not v1. If your users include Korean, Japanese, or Chinese speakers, v1 is broken — IME composition lands in the wrong cells. v2 fixes this. This document is the reference setup.

The reference implementation this document is distilled from is an IME-focused floating window manager built specifically to nail down v2 + IME.
...
- IME-focused bubbletea v2 window-manager reference notes
