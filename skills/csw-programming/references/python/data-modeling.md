...
Do not add Pydantic to internal-only data solely for convenience. Use it where runtime validation,
serialization, repository consistency, or a shared boundary provides concrete value.
