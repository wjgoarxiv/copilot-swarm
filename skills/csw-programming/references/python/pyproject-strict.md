...
The reference "super strict but sane" config for modern Python projects. Copy-paste, then add your own dependencies.
...
When the repository configures equivalent type and lint checks, the combined policy can enforce:
