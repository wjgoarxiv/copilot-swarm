...
This reference compares capabilities; it is not a workspace manifest. Preserve `Cargo.toml`, the
lockfile, MSRV, enabled features, targets, and established crates. A new crate requires a concrete
gap, current maintenance and security review, feature and target compatibility, and an approved
version.
